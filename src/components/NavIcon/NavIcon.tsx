...
const NavIcon: React.FC<{size: string, className?: string}> = ({className, size}) => (
    <svg width={size} height={size} viewBox="0 0 16 16" className={"bi bi-arrows-fullscreen " + (className !== undefined ? className : '')} fill="#575757" xmlns="http://www.w3.org/2000/svg">
